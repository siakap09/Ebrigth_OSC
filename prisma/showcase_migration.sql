-- Annual Showcase module tables and enums
-- Applied directly because the DB has schema drift from prior manual changes

-- CreateEnum
CREATE TYPE "ShowcaseEditionStatus" AS ENUM ('DRAFT', 'REGISTRATION_OPEN', 'TEST_RUN', 'EVENT_ACTIVE', 'POST_EVENT', 'ARCHIVED');

-- CreateEnum
CREATE TYPE "ShowcaseTaskStatus" AS ENUM ('TODO', 'IN_PROGRESS', 'IN_REVIEW', 'DONE');

-- CreateEnum
CREATE TYPE "ShowcaseTaskPriority" AS ENUM ('LOW', 'MEDIUM', 'HIGH', 'URGENT');

-- CreateEnum
CREATE TYPE "ShowcaseBudgetType" AS ENUM ('REVENUE', 'EXPENSE');

-- CreateEnum
CREATE TYPE "ShowcaseBudgetItemStatus" AS ENUM ('PENDING', 'APPROVED', 'PAID', 'REJECTED');

-- CreateEnum
CREATE TYPE "ShowcaseSponsorStatus" AS ENUM ('PROSPECT', 'CONTACTED', 'NEGOTIATING', 'CONFIRMED', 'DECLINED');
