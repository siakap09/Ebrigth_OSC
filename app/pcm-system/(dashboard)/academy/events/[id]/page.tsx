...
import { EditEventModal } from "@pcm/_components/fa/EditEventModal";
import { MarketingEventStatCard } from "@pcm/_components/fa/MarketingEventStatCard";
import { StatusActionBar } from "@pcm/_components/fa/StatusActionBar";
import { InvitationWindowStatus } from "@pcm/_components/fa/InvitationWindowStatus";
import { SessionFormModal } from "@pcm/_components/fa/SessionFormModal";
import { BulkSessionEditorModal } from "@pcm/_components/fa/BulkSessionEditorModal";
import { QuotaModal } from "@pcm/_components/fa/QuotaModal";
import { MarketingSessionInvitesModal } from "@pcm/_components/fa/MarketingSessionInvitesModal";
import { EventInvitationListCard } from "@pcm/_components/fa/EventInvitationListCard";
import { EventStatus, Session } from "@pcm/_types";
...
export default function MarketingEventDetailPage() {
    ...
    return (
      <AppShell>
        <div className="text-center py-20">
          ...
          <Link href="/pcm-system/academy" className="fa-btn-primary mt-4 inline-flex">Back to events</Link>
        </div>
      </AppShell>
    );
  }
  ...
  function handleDeleteEvent() { deleteEvent(eventId); router.push("/pcm-system/academy"); }
