...
import { EditEventModal, EditEventPatch } from "@pcm/_components/fa/EditEventModal";
import { PreviewEventModal } from "@pcm/_components/fa/PreviewEventModal";
import { HeroCard } from "@pcm/_components/fa/HeroCard";
      ...
      <div className="fa-enter">
        <div className="flex items-end justify-between gap-6">
          ...
          <div className="mb-1 flex-shrink-0">
            <Link href="/pcm-system/academy/events/new" className="fa-btn-primary">
