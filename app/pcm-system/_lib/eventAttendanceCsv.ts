...
// details. Used by both the Attendance page and the Academy event detail.
// ============================================================================

import { BRANCHES, FAEvent, Invitation, Session, Student, User, hasBacklog } from "@pcm/_types";
