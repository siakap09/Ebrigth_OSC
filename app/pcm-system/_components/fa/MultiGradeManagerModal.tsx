...
import { BRANCHES, BranchCode, DayPolicy, EventBranchOverride, FAEvent } from "@pcm/_types";
...
// The three day-policies Academy can pick per unlocked branch. `short` is the
